...
### 2.1
On considère un problème de commande optimale à temps final fixé, et à condition initiale connue, dont la conditions terminale est (état de dimension $2$)

$$ x_1^2(t_f) - x_2^2(t_f) = 1. $$
...
### 2.3
Dans le code MPC ci-dessous, que représente le vecteur `ts` ?
...
### 2.5
Dans le code Hexapawn ci-dessous, expliquer à quoi correspond la variable `l`.
